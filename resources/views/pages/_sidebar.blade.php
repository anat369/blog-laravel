<div class="col-md-4" data-sticky_column>
    <div class="primary-sidebar">
        ...
        <aside class="widget news-letter">
            <h3 class="widget-title text-uppercase text-center">Подписаться на новости</h3>
            <form action="/subscribe" method="post">
                {{csrf_field()}}
                <input type="email" placeholder="Введите ваш email" name="email" required>
        ...
        <aside class="widget">
            <h3 class="widget-title text-uppercase text-center">Рекомендуемые статьи</h3>
